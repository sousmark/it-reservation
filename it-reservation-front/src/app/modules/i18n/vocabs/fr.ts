...
export const locale = {
  ...
  data: {
    ...
    MENU: {
      ...
      STAFF: 'Employés',
      SERVICES: 'Services',
      BUSINESS_INFORMATION: 'Informations professionnelles',
    },
    AUTH: {
      IPN: 'IPN',
      LOGIN_FAILED: 'Les informations d\'identification sont incorrectes ou vous n\'êtes pas autorisé à utiliser cette application.',
      GENERAL: {
        OR: 'Ou',
      ...
      LOGIN: {
        ...
        BUTTON: 'Sign In',
        LOGIN_WITH_IDP: 'Connexion avec IDP',
      },
      FORGOT: {
    ...
    ERROR: {
      DELETE_CONFIRMATION_MESSAGE: 'Les données sélectionnées seront supprimées. Voulez-vous continuer?'
    },
    LABELS: {
