...
export class TopbarComponent implements OnInit, AfterViewInit {
  ...
  constructor(private layout: LayoutService, private authService: AuthenticationService) {
    if (this.authService.getCurrentUserValue().username === 'uname') {
  ...
  ngOnInit(): void {
    ...
    this.extrasUserDisplay = true; //this.layout.getProp('extras.user.display');
    this.extrasUserLayout = "dropdown"; //this.layout.getProp('extras.user.layout');
